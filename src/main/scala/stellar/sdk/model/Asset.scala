...
import stellar.sdk.util.ByteArrays.{paddedByteArray, paddedByteArrayToString}
import stellar.sdk.{KeyPair, PublicKeyOps}

sealed trait Asset {
  val code: String
  def canoncialString: String
  def xdr: org.stellar.xdr.Asset
}
    ...
    asset.getDiscriminant match {
      ...
      case AssetType.ASSET_TYPE_CREDIT_ALPHANUM4 =>
        IssuedAsset4(
          ...
          issuer = AccountId.decode(asset.getAlphaNum4.getIssuer).publicKey
        )
      case AssetType.ASSET_TYPE_CREDIT_ALPHANUM12 =>
        IssuedAsset12(
          code = paddedByteArrayToString(asset.getAlphaNum12.getAssetCode.getAssetCode12),
          issuer = AccountId.decode(asset.getAlphaNum12.getIssuer).publicKey
        )
    }
  }
