...
// todo - when the transaction is attempted, but failed, it will come back rejected/failure
...
// todo - what happens when we get a "NotAttempted" result? Like _TooEarly_
